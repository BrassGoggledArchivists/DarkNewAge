 ...
 *
 */
package darknewage.common.blocks;
 ...
 *
 */
public class BlockFluidPlasma extends BlockFluidClassic
{
	...
	{
		// this.blockIcon = iconRegister.registerIcon(ModInfo.PREFIX +
		// "steamStill");
		// iconFlowing = iconRegister.registerIcon(ModInfo.PREFIX +
		// "steamFlowing");
	}
